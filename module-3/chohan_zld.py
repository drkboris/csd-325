...
Notice: If the dice total is 2 or 7, you receive a 10 mon bonus added
to your purse!
''')
...
while True:  # Main game loop.
    ...
    # Check for dice roll bonus (total of 2 or 7):
    rollTotal = dice1 + dice2
    if rollTotal == 2 or rollTotal == 7:
        print('The dice total is', rollTotal, '-- you get a 10 mon bonus!')
        purse = purse + 10
